...
bool ChessPiece::extractNextFace1(string& in, string& out, int& pointIdx0, int& pointIdx1, int& pointIdx2 )
{
    GLuint a,b,c;
...
bool ChessPiece::extractNextFace3(string& in, string& out, int& pointIdx, int& texIdx, int& normalIdx )
{
    GLuint a,b,c;
 ...
 */
void ChessPiece::initShader(void)
{
...
*/
void ChessPiece::updateVertices(float* vertices)
{
