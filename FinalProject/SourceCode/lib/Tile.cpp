...
Tile::Tile(float center_x, float center_y, float center_z, float width, float height,  int rows, int cols  ):
 ...
 */
void Tile::make_box(float center_x, float center_y, float center_z, float width,
